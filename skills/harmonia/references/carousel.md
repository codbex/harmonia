...
`x-h-carousel` is the root. The directives compose one component and must be nested as shown in the Examples below (the library throws at runtime when a required ancestor is missing):
...
Full docs: https://www.codbex.com/harmonia/components/carousel.html
