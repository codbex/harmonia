...
Harmonia automatically configures the color scheme during initialization, including persisting the user’s most recently selected preference.

To retrieve or manually configure the color scheme, refer to the [Theme](/utilities/theme) utility in the Utilities section.
