...
| topFrame   | boolean         | false    | By default, the listener measures the current frame. This attaches it to the topmost frame instead, falling back to the current frame when that frame belongs to another origin. |
