...
export const buttonVariants = {
  default: [
    ...
    'aria-disabled:hover:bg-secondary',
    'aria-disabled:active:bg-secondary',
    'aria-disabled:aria-pressed:bg-secondary-active',
    'aria-disabled:data-[toggled=true]:bg-secondary-active',
  ],
  primary: [
    'bg-primary',
    ...
    'aria-disabled:hover:bg-primary',
    'aria-disabled:active:bg-primary',
    'aria-disabled:aria-pressed:bg-primary-active',
    'aria-disabled:data-[toggled=true]:bg-primary-active',
  ],
  positive: [
    'bg-positive',
    ...
    'aria-disabled:hover:bg-positive',
    'aria-disabled:active:bg-positive',
    'aria-disabled:aria-pressed:bg-positive-active',
    'aria-disabled:data-[toggled=true]:bg-positive-active',
  ],
  negative: [
    'bg-negative',
    ...
    'aria-disabled:hover:bg-negative',
    'aria-disabled:active:bg-negative',
    'aria-disabled:aria-pressed:bg-negative-active',
    'aria-disabled:data-[toggled=true]:bg-negative-active',
  ],
  warning: [
    'bg-warning',
    ...
    'aria-disabled:hover:bg-warning',
    'aria-disabled:active:bg-warning',
    'aria-disabled:aria-pressed:bg-warning-active',
    'aria-disabled:data-[toggled=true]:bg-warning-active',
  ],
  information: [
    'bg-information',
    ...
    'aria-disabled:hover:bg-information',
    'aria-disabled:active:bg-information',
    'aria-disabled:aria-pressed:bg-information-active',
    'aria-disabled:data-[toggled=true]:bg-information-active',
  ],
  outline: [
    'border',
    'bg-background',
    ...
    'aria-disabled:hover:fill-foreground',
    'aria-disabled:active:bg-background',
    'aria-disabled:active:text-foreground',
    'aria-disabled:active:fill-foreground',
    'aria-disabled:aria-pressed:bg-secondary-active',
    'aria-disabled:aria-pressed:text-secondary-foreground',
    'aria-disabled:aria-pressed:fill-secondary-foreground',
    'aria-disabled:data-[toggled=true]:bg-secondary-active',
    'aria-disabled:data-[toggled=true]:text-secondary-foreground',
    'aria-disabled:data-[toggled=true]:fill-secondary-foreground',
  ],
  transparent: [
    'bg-transparent',
    'text-foreground',
